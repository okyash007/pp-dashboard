...
const RazorparBtnEditor = ({ block, setBlock }) => {
  return (
    <div className='space-y-1'>
      <p className='text-lg font-bold text-gray-600 text-center '>Razorpay Button Configuration</p>
      <div className='space-y-3 rounded-xl p-3'>
        <div>
          <Label className='text-sm font-bold text-gray-600 block mb-1'>Button Text</Label>
          <Input
            type='text'
        ...
        <div>
          <Label className='text-sm font-bold text-gray-600 block mb-1'>Text Color</Label>
          <ColorPicker
