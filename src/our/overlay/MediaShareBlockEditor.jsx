...
export const dummyMediaShareData = {
  ...
  message: 'Hey! Just wanted to say your content really lifts my mood after long days.',
  created_at: Date.now(),
  amount: 20000,
  currency: 'INR',
...
export const dummyMediaShareBlocks = [
  {
    ...
    template: [
      ...
      '            <img src="{{ avatar_url | default: data.tipper_image | default: \'https://yt3.googleusercontent.com/1b09zxEEjWfX0FNgqBhRnvR3nDIri68IwpcMwFQQlpujQlmg8EKkcEIZCLBPvReuBZk2H_0GUQ=s900-c-k-c0x00ffffff-no-rj\' }}" alt="{{ display_name | default: \'Potato Pal\' }}" class="w-full h-full object-cover" style="filter: contrast(1.05) saturate(1.1);" />',
      '          </div>',
          ...
          <div className='space-y-4'>
            <div className='space-y-3 pt-2 bg-white rounded-lg p-2 border-2 border-black'>
              <div className='flex items-center justify-between'>
                <Label className='text-xs font-bold text-gray-500'>Media Share Time</Label>
            ...
            <div className='mt-4 p-3 bg-yellow-50 border-2 border-yellow-300 rounded-lg'>
              <p className='text-xs font-semibold text-yellow-800 mb-1'>⚠️ Copyright Notice</p>
