...
const TipAmounts = () => {
  ...
  if (!amounts) {
    return (
      <div className='bg-[#F5F5F5] border-[6px] border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] p-6'>
        <div className='text-center text-black font-semibold'>No tip amounts found</div>
      </div>
    );
  }
  ...
  return (
    <div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
        ...
        <div className='relative group -rotate-1'>
          <div className='relative h-full bg-[#FEC4FF] border-[5px] border-black p-5 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:rotate-0 transition-all duration-200'>
            <div className='relative z-10'>
              <div className='flex items-center justify-between mb-2'>
