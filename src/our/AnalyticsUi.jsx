          ...
          <div className='relative h-full bg-[#FEF18C] border-[6px] border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] overflow-hidden hover:shadow-[7px_7px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 transition-all duration-200'>
            ...
            <div className='relative z-10 p-6 h-full flex flex-col justify-between'>
              ...
              <div>
                ...
                {data.breakdown_by_currency && data.breakdown_by_currency.length > 0 && (
          ...
          <div className='relative h-full bg-[#FEC4FF] border-[5px] border-black p-5 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:translate-x-0.5 hover:translate-y-0.5 transition-all duration-200'>
            ...
            <div className='relative z-10'>
              ...
              <div className='inline-flex items-center gap-1 bg-white border-[2px] border-black px-2 py-1'>
                ...
                <span className='text-xs font-black text-green-600'>+14.0%</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className='relative h-full bg-[#828BF8] border-[5px] border-black p-5 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:rotate-0 transition-all duration-200'>
            <div className='relative z-10'>
              ...
              <div className='relative bg-white border-[2px] border-black px-3 py-1 w-fit'>
                <span className='text-xs font-black text-green-600'>+0.49%</span>
